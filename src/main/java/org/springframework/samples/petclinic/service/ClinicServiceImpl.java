...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Override
    public Collection<Visit> findVisits(LocalDate date) throws DataAccessException {
        return visitRepository.findByDate(Date.from(date.atStartOfDay(ZoneId.systemDefault()).toInstant()));
    }
